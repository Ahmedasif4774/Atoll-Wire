...
import { formatDaysLeftLabel, getArticle, getCategory, getDaysLeft } from "@/lib/data";
import { homeConfigDv as cfg } from "@/lib/homeConfig.dv";
import type { CategorySlug } from "@/lib/types";

function req(slug: string) {
  const a = getArticle("dv", slug);
...
type LatestEntry = (typeof cfg)["latestMixed"][number];
const AD_DISPLAY_INDEX = 3;
function withPinnedAd(entries: LatestEntry[], pinnedIndex: number): LatestEntry[] {
