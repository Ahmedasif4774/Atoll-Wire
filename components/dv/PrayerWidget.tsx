...
const PRAYER_META: { key: PrayerKey; icon: string; name: string }[] = [
  { key: "fajr", icon: "🌙", name: "ފަތިސް" },
  { key: "sunrise", icon: "🌅", name: "އިރުއަރާ" },
  { key: "dhuhr", icon: "☀️", name: "މެންދުރު" },
  { key: "asr", icon: "🌤️", name: "ޢަޞްރު" },
  { key: "maghrib", icon: "🌇", name: "މަޣްރިބް" },
  { key: "isha", icon: "✨", name: "ޢިޝާ" },
];
